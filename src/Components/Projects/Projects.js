...
const Projects = () => {
  ...
  return (
    <div id='Projects'  data-aos="flip-down" className="container mb-5 pb-5 mt-5 pt-5">
      ...
      <div className="row d-flex justify-content-between">
        <div className="col-lg-3 cl-md-6 cl-sm-12 project-div">
          ...
          <div>
            {" "}
            <h5 style={{ color: "green" }}  className="mt-2">Creative Agency</h5>
          </div>
          <h6 style={{ color: "gray" }}>
          ...
          <>
            <div className="row d-flex justify-content-center m-auto p-2">
              <div className="col-4 text-muted ">
                <h4>
                  <a href="https://github.com/riduanul/creative-agency-client" target="_blank">
              ...
              <div className="col-4 text-muted ">
                <h4>
                  <a href="https://creative-agency-f72c4.web.app/" target="_blank">
                    <BiLinkExternal />
                  </a>
                </h4>
              </div>
              <div className="col-4 text-muted ">
                <h4>
                  <a href="https://github.com/riduanul/creative-agency-server" target="_blank">
                    <FaGithubSquare />
                  </a>
                </h4>
              </div>
        ...
        <div className="col-lg-3 cl-md-6 cl-sm-12 project-div">
          ...
          <div>
            {" "}
            <h5 style={{ color: "green" }} className="mt-2">Volunteer Network</h5>
          </div>
          <h6 style={{ color: "gray" }}>
          ...
          <>
            <div className="row d-flex justify-content-center m-auto p-2">
              <div className="col-4 text-muted ">
                <h4>
                  <a href="https://github.com/riduanul/volunteer-network-client " target="_blank">
                    {" "}
                    <FaGithub />
                  </a>
                </h4>
              ...
              <div className="col-4 text-muted ">
                <h4>
                  <a href="https://volunteer-network-309d5.web.app/" target="_blank">
                    <BiLinkExternal />{" "}
                  </a>
                </h4>
              </div>
              <div className="col-4 text-muted ">
                <h4>
                  <a href="https://github.com/riduanul/volunteer-network-server" target="_blank">
                    <FaGithubSquare />
                  </a>
                </h4>
              </div>
          ...
          <>
            <div className="row d-flex justify-content-center m-auto p-2">
              <div className="col-3 text-muted ">
                <h4>
                  <a href="https://github.com/riduanul/traveller" target="_blank">
                    {" "}
                    <FaGithub />
                  </a>
                </h4>
              ...
              <div className="col-4 text-muted ">
                <h4>
                  <a href="https://traval-guru-64b7c.firebaseapp.com/home" target="_blank">
                    <BiLinkExternal />{" "}
                  </a>
                </h4>
              </div>
      ...
      <div style={{ color: "white", textAlign: "right" }}> <a href="">See more</a> </div>
    </div>
  );
};
